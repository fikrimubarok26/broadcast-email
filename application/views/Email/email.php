                    ...
                    <div style="height: 100vh;">
                        ...
                        <form action="<?= base_url('email/kirim') ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="asal" class="form-control"  require>
                                    <option value=""> -- Silakan Pilih -- </option>
                                    <?php foreach ($datapengirim as $uwu ):?> >
                                        <option value="<?= $uwu->id?>"><?= $uwu->email?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            ...
                            <input type="hidden" value=" " name="id_user" class="form-control" id="valPersonal">
                            <input type="hidden" value=" " name="id_pangkat" class="form-control" id="valPangkat">
                            ...
                            <div class="form-group">
                                ...
                                <textarea cols="30" name="isi_surat" id="surat" class="summernote" placeholder="Pesan Email" rows="10"></textarea>
                            </div>
